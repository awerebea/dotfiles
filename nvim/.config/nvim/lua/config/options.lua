...
end, { desc = "Toggle snacks/fzf-lua/telescope keymaps" })
-- }}} end of Toggle snacks/fzf-lua/telescope keymaps
...
-- Change cursor view:
vim.opt.guicursor =
  "n-v-c-sm:block,i-ci-ve:ver25-Cursor,r-cr-o:hor20,a:blinkwait700-blinkon500-blinkoff500"
