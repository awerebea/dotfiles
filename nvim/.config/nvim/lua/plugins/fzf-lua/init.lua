  ...
  config = function()
    ...
    require("fzf-lua").setup {
      ...
      winopts = {
        ...
        row = 0.80, -- window row position (0=top, 1=bottom)
        ...
        preview = {
          ...
          flip_columns = 220, -- #cols to switch to horizontal on flex
      ...
      previewers = {
        ...
        builtin = {
          ...
          syntax_limit_b = 100 * 1024, -- syntax limit (bytes), 0=nolimit
      ...
      files = {
        ...
        rg_opts = [[--color=never --files --hidden -g "!.git" -g "!.venv"]],
